...
const projectImages: ProjectImage[] = [
  {
    ...
    linkedinUrl: 'https://www.linkedin.com/feed/update/urn:li:activity:7380602336026595328/'
  },
  {
    image: '/dfg/DFG1.webp',
    label: 'Developed data solution for domestic violence NGO',
    linkedinUrl: 'https://www.linkedin.com/feed/update/urn:li:activity:7380602336026595328/'
  }
];

export const DFGCarousel: React.FC = () => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="JPMC DataForGood carousel"
    >
      {/* Project Image Display */}
      <div className="relative aspect-square overflow-hidden rounded-2xl bg-gray-100 hover:shadow-lg transition-all duration-300">
      ...
      <div className="flex justify-center mb-4">
        <a
          href={currentProject.linkedinUrl}
          target="_blank"
